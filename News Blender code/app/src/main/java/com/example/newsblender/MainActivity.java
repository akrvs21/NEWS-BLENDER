...
import com.example.newsblender.api.ApiClient;
import com.example.newsblender.api.ApiInterface;
...
public class MainActivity<object> extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(flag==false)
        {
            ...
            TapTargetView.showFor(this,                 // `this` is an Activity
                    TapTarget.forView(findViewById(R.id.fabThree), "Finance & Business", "Here are the Hot News about Finance and Stock markets")
                            .tintTarget(false)
                            .outerCircleColor(R.color.light_blue)      // Specify a color for the outer circle
                            .titleTextSize(30)                  // Specify the size (in sp) of the title text
                            .titleTextColor(R.color.demo_text)      // Specify the color of the title text
                            .descriptionTextSize(25)// Specify the size (in sp) of the description text
                            .descriptionTextColor(R.color.demo_text)  // Specify the color of the description text
            ...
            TapTargetView.showFor(this,                 // `this` is an Activity
                    TapTarget.forView(findViewById(R.id.fabTwo), "Apple", "Here you can see latest updates about Apple products")
                            .tintTarget(false)
                            .outerCircleColor(R.color.light_blue)      // Specify a color for the outer circle
                            .titleTextSize(30)                  // Specify the size (in sp) of the title text
                            .titleTextColor(R.color.demo_text)      // Specify the color of the title text
            ...
            TapTargetView.showFor(this,                 // `this` is an Activity
                    TapTarget.forView(findViewById(R.id.fabOne), "Bitcoin", "Here are the Hot News about Bitcoin and Blockchain industry")
                            .tintTarget(false)
                            .outerCircleColor(R.color.light_blue)      // Specify a color for the outer circle
                            .titleTextSize(30)                  // Specify the size (in sp) of the title text
                            .titleTextColor(R.color.demo_text)      // Specify the color of the title text
            ...
            TapTargetView.showFor(this,                 // `this` is an Activity
                    TapTarget.forView(findViewById(R.id.fabMain), "This is Main Button", "Press it to view all sorts of News")
                            .tintTarget(false)
                            .outerCircleColor(R.color.light_blue)      // Specify a color for the outer circle
                            .titleTextSize(30)                  // Specify the size (in sp) of the title text
                            .titleTextColor(R.color.demo_text)      // Specify the color of the title text
